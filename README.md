...
*******************************************************************************************************************************  
** Google's AIY image has the environment in a different directory, which will not work with this project.                   **
**   So please use the Standard Raspbian Desktop/Lite image- [Link](https://www.raspberrypi.org/downloads/raspbian/)         **  
*******************************************************************************************************************************
...
```
git clone https://github.com/hack-r/Ilana    
```
...
AIY-HAT and CUSTOM-HAT users, please reboot the Pi at places mentioned, else it will lead to audio and taskbar issues.**  
  ...
  ```
  sudo chmod +x /home/pi/Desktop/Ilana/audio-drivers/USB-DAC/scripts/install-usb-dac.sh  
  sudo /home/pi/Desktop/Ilana/audio-drivers/USB-DAC/scripts/install-usb-dac.sh
  speaker-test  
  ```

  3.2. AIY-HAT users,  
  ```
  sudo chmod +x /home/pi/Desktop/Ilana/audio-drivers/AIY-HAT/scripts/configure-driver.sh  
  sudo /home/pi/Desktop/Ilana/audio-drivers/AIY-HAT/scripts/configure-driver.sh  
  sudo reboot  
  sudo chmod +x /home/pi/Desktop/Ilana/audio-drivers/AIY-HAT/scripts/install-alsa-config.sh  
  sudo /home/pi/Desktop/Ilana/audio-drivers/AIY-HAT/scripts/install-alsa-config.sh  
  speaker-test  
  ```

  3.3. USB MIC AND HDMI users,  
  ```
  sudo chmod +x /home/pi/Desktop/Ilana/audio-drivers/USB-MIC-HDMI/scripts/install-usb-mic-hdmi.sh  
  sudo /home/pi/Desktop/Ilana/audio-drivers/USB-MIC-HDMI/scripts/install-usb-mic-hdmi.sh  
  speaker-test  
  ```

  3.4. USB MIC AND AUDIO JACK users,  
  ```
  sudo chmod +x /home/pi/Desktop/Ilana/audio-drivers/USB-MIC-JACK/scripts/usb-mic-onboard-jack.sh  
  sudo /home/pi/Desktop/Ilana/audio-drivers/USB-MIC-JACK/scripts/usb-mic-onboard-jack.sh  
  speaker-test  
  ```

  3.5. CUSTOM VOICE HAT users,  
  ```
  sudo chmod +x /home/pi/Desktop/Ilana/audio-drivers/CUSTOM-VOICE-HAT/scripts/install-i2s.sh  
  sudo /home/pi/Desktop/Ilana/audio-drivers/CUSTOM-VOICE-HAT/scripts/install-i2s.sh
  sudo reboot
  sudo chmod +x /home/pi/Desktop/Ilana/audio-drivers/CUSTOM-VOICE-HAT/scripts/custom-voice-hat.sh  
  sudo /home/pi/Desktop/Ilana/audio-drivers/CUSTOM-VOICE-HAT/scripts/custom-voice-hat.sh  
  speaker-test   
  ```
...
**Pi3 and Armv7 users use the "gassist-installer-pi3.sh" installer and Pi Zero, Pi A and Pi 1 B+ users use the "gassist-installer-pi-zero.sh" installer.**  
	...
	```
	sudo chmod +x /home/pi/Desktop/Ilana/scripts/gassist-installer-pi3.sh
	sudo chmod +x /home/pi/Desktop/Ilana/scripts/gassist-installer-pi-zero.sh
	...
	```
	sudo  /home/pi/Desktop/Ilana/scripts/gassist-installer-pi3.sh  
	sudo  /home/pi/Desktop/Ilana/scripts/gassist-installer-pi-zero.sh
...
*************************************************  
1. Open the service files in the /home/pi/Desktop/Ilana/systemd/ directory and add your project and model ids in the indicated places and save the file.

2. Make the service installer executable  

```
sudo chmod +x /home/pi/Desktop/Ilana/scripts/service-installer.sh
```  

3. Run the service installer  

```
sudo /home/pi/Desktop/Ilana/scripts/service-installer.sh    
```  

4. Enable the services - **Pi3 and Armv7 users, enable the "Desktop/Ilana-ok-ggogle.service" and Pi Zero, Pi A and Pi 1 B+ users, enable "gassistpi-push-button.service"**          
...
Open a terminal and execute the following:
```
/home/pi/env/bin/python -u /home/pi/Desktop/Ilana/src/pushbutton.py --project-id 'replace this with your project id'  --device-model-id 'replace this with the model id'
...
Advantage of using Sonoff-Tasmota over webserver is that, with Sonoff-Tasmota you can emulate a Wemo switch and control the NodeMCU using Amazon Alexa (Echo Devices) in addition to the Pi.    
