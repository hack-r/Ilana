...
logging.basicConfig(filename='/home/pi/Desktop/ilana.log', level=logging.DEBUG,
...
def process_event(event, device_id):
    ...
    if event.type == EventType.ON_CONVERSATION_TURN_STARTED:
        subprocess.Popen(["aplay", "/home/pi/Desktop/Ilana/sample-audio-files/Fb.wav"], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
